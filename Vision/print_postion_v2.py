...
while 1:
  ...
  pixy.getBlocks(true, 1)
  count = pixy.numBlocks
  ...
  if count > 0:
    ...
    #    posz[index] = 
        ...
        posz.append((taille_objet_reel*0.68)/taille_objet_image)
        ...
        posx.append((1/315)*blocks[index].m_x*taille_fov_reel)
